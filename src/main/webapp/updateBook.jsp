        ...
        <div class="col-md-7">
            <form name="newBook" action="./processUpdateBook.jsp" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="radio" name="condition" value="New" <% if(rs.getString("b_condition").equals("New")) out.print("checked") %>>신규도서
                        <input type="radio" name="condition" value="Old" <% if(rs.getString("b_condition").equals("Old")) out.print("checked") %>>중고도서
                        <input type="radio" name="condition" value="EBook" <% if(rs.getString("b_condition").equals("EBook")) out.print("checked") %>>E-Book
                    </div>
                </div>
                <div class="mb-3 row">
